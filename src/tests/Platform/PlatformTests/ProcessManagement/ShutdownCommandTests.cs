...
/// other builds, but not the current process and its parents, which include the <c>dotnet test</c> that runs these tests.
/// Run them in a container, or on an agent that runs one build at a time.
/// </remarks>
