...
#if METALAMA_BACKSTAGE
    /// <summary>
    /// Gets the prefix of the names of the machine-wide locks of the product, for instance <c>Global\Metalama_</c>.
    /// It comes from the product profile, so that two products never share a lock.
    /// </summary>
    string GlobalLockNamePrefix { get; }
#endif
