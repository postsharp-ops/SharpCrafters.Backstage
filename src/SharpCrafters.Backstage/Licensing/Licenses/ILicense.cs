...
namespace SharpCrafters.Backstage.Licensing.Licenses
{
    ...
    {
        /// <summary>
        /// Gets what prevents the licence from being registered, or
        /// <see cref="LicenseRegistrationBlocker.None"/> when nothing does.
        /// </summary>
        /// <param name="cancellationToken">A cancellation token.</param>
        ValueTask<LicenseRegistrationBlocker> GetRegistrationBlockerAsync( CancellationToken cancellationToken = default );
