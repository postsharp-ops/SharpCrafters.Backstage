...
internal abstract class ParentProcessSearch<TProcessHandle> : ParentProcessSearch
#pragma warning restore SA1649
{
    protected ParentProcessSearch( IServiceProvider serviceProvider ) : base( serviceProvider ) { }
