...
internal sealed class ParentProcessSearchWindows : ParentProcessSearch<IntPtr>
{
    public ParentProcessSearchWindows( IServiceProvider serviceProvider ) : base( serviceProvider ) { }
