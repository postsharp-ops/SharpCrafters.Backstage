...
#pragma warning disable CA1305
            ...
            AppendLineSafe(
                "Process",
                () =>
                    $"{Process.GetCurrentProcess().ProcessName} {this._scrubber.RemoveSensitiveData( Environment.CommandLine )}" );
            ...
            AppendLineSafe( "Exception message", () => this._scrubber.RemoveSensitiveData( exception.Message ) );

            try
            {
                // The next line may fail.
                var exceptionToString = this._scrubber.RemoveSensitiveData( exception.ToString() );
            ...
            try
            {
                var loaderExceptionsText = LoaderExceptionsHelper.GetLoaderExceptionsText(
                    exception,
                    this._scrubber.RemoveSensitiveData );
            ...
            try
            {
                ...
                exceptionText.AppendLine( this._scrubber.RemoveSensitiveData( Environment.StackTrace ) );
            }
