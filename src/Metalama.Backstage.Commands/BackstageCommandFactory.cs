...
#pragma warning disable CS0612 // Type or member is obsolete
                        license.AddCommand<RegisterLegacyFreeCommand>( "free" )
                            .WithData( options )
                            .WithDescription( $"Registers the legacy {productName} Free license (for {productName} 2025.0 and earlier)." );
#pragma warning restore CS0612 // Type or member is obsolete
                ...
                appConfig.AddCommand<KillCommand>( "kill" )
                    .WithData( options )
                    .WithDescription( $"Terminates processes that may be locking {productName} packages." );
