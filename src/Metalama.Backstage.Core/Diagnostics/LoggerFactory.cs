...
namespace Metalama.Backstage.Diagnostics
{
    internal sealed class LoggerFactory : ILoggerFactory
    {
            ...
            ProcessKind processKind )
        {
            ...
            this.ProductName = serviceProvider.GetRequiredBackstageService<ProductProfile>().Name;
        ...
        /// <summary>
        /// Gets the name of the product, which prefixes the names of the log files.
        /// </summary>
